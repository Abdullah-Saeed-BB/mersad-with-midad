...
انشئت هذي نسخة من مشروع مِرصاد (النسخة المنظمة) لتسهل على مجتمع المبرمجين التعديل و التطوير على تطبيق مِرصاد. تم اعادة تصميم هيكلة المشروع لتتماشة مع افضل ممارسات تطوير تطبيقات الويب, فتم وضع الاكواد في مجلد الـ `/src` فصل الاكواد الـ _CSS_ و الـ _Javascript_ في مجلدات مختلفة. كتبت طريقة تشغيل المشروع وطريقة تثبيت **خطوط ثمانية** في تطبيق مِرصاد, في فقرة **"التثبيت و التشغيل"**.
