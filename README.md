<img width="1920" height="276" alt="mersad_repo_banner" src="https://github.com/user-attachments/assets/9bb9ff4d-8048-4b3d-aa9e-4c76e411f8a9" />

# مِرصاد (النسخة المنظمة)

مِرصاد هو تطبيق انشائه الاستاذ [حاتم النجار](https://github.com/HatemAlNajjar) ليساعد المصورين في إدارة وتنظيم عمليات التصوير ( زي الـ **Call Sheet**). يوجد [مقطع في اليوتيوب](https://www.youtube.com/watch?v=77tL-XDIPhk) يشرح التطبيق بشكل مفصل.

انشئت هذي نسخة من مشروع مِرصاد (النسخة المنظمة) لتسهل على مجتمع المبرمجين التعديل و التطوير على تطبيق مِرصاد, وهذي النسخة الاساسية التي بنيت عليها [مساعد مِداد](https://github.com/Abdullah-Saeed-BB/mersad-with-midad/). تم اعادة تصميم هيكلة المشروع لتتماشة مع افضل ممارسات تطوير تطبيقات الويب, فتم وضع الاكواد في مجلد الـ `/src` فصل الاكواد الـ _CSS_ و الـ _Javascript_ في مجلدات مختلفة.
