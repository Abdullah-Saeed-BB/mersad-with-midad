...
3. افتح مجلد المشروع وثم مجلد `src/` وانقر بزر الماوس الأيمن على ملف `index.html` واضغط على **"فتح"**.
4. بعد تشغيل التطبيق، وعند فتح **مِداد** لأول مرة، سيُطلب منك إدخال مفتاح واجهة برمجة تطبيقات (API Key) الخاص بـ **Gemini**. يمكنك الحصول على مفتاح مجاني من خلال **[Google AI Studio](https://aistudio.google.com/)** باتباع الخطوات التالية:
	1. سجّل الدخول إلى موقع **Google AI Studio**.
	2. انتقل إلى **Dashboard**، ثم افتح صفحة **API Keys**.
	3. اضغط على **Create API Key** الموجودة في الزاوية العلوية اليمنى من الصفحة.
	4. اضغط على **Create Key**، ثم انسخ المفتاح باستخدام زر النسخ الموجود بجواره.
### (اختياري) تثبيت خطوط ثمانية
لتثبيت خطوط ثمانية على مِرصاد, إذهب إلى موقع الرسمي لي [خطوط ثمانية](https://font.thmanyah.com/) وقم بي تحميل الخطوط, بعد تحميل وفك الضغط للمجلد, إذهب لي مجلد `thmanyah typeface`  وسيتواجد مجلدين اساسين هما:
...
## محتوى اضافي
 - كيف بنيت وكيل مِداد | [ثريد في إكس (تويتر)](https://x.com/Abdullah_SBB/status/2079600721498865848)
